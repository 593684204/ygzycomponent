...
export default class App extends Component<{}> {
            ...
            <TouchableHighlight
                ...
                <View style={{height:100,flexDirection:'row',justifyContent:'flex-start',alignItems:'center',}}>
                    <View style={{height:100,width:100}}>
                        <Image style={{height:100,width:100}} source={{uri:item.schoolLogoUrl}} resizeMode={'contain'}/>
                    </View>
                ...
                }
                {
                    this.state.opacityLoading?
                        <View style={{width:Util.size.width,height:Util.size.height,position:'absolute',top:0,left:0,justifyContent:'center',alignItems:'center'}}>
                            <Image source={require('./resources/images/loading.gif')} resizeMode='contain' style={{width: 25, height:25} }  />
                        </View>
                        :
                        null
                }
    ...
    fetchData=()=> {
        /*let baseUrl='https://test.ygzykj.com:1901/sunsoft-supplier-app/school/selectSchoolIdAndSchoolInfo.json?token=a4ce06b498cddf17f73d2ac5bdf93865&versionCode=101.1.8&upPwsNum=3&versionType=10' +
            '&provinceRegionId=&cityRegionId=&districtRegionId=&schoolName=&pageNo=1&pageSize='+this.state.pageSize+'&status=00'
        let _q='';*/
        let baseUrl='sunsoft-supplier-app/school/selectSchoolIdAndSchoolInfo.json';
        let paramData={
        ...
        axios.get(baseUrl,paramData).then(data=>{
            console.log(data);
            let _data=data.data.obj.body;
            console.log(_data);
            this.setState({
                data:_data.rows,
